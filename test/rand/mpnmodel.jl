...
@test_throws ArgumentError rand(MinimumPotentialNicheModel(10, 99, 0))
@test_throws ArgumentError rand(MinimumPotentialNicheModel(10, 51, 0))
@test_throws ArgumentError rand(MinimumPotentialNicheModel(10, 50, 0))
@test_throws ArgumentError rand(MinimumPotentialNicheModel(10, 200, 0))
@test_throws ArgumentError rand(MinimumPotentialNicheModel(10, 0, 0))
