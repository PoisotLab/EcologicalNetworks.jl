module TestTypes
    ...
    @test typeof(BipartiteNetwork(rand(3, 3))) == BipartiteNetwork
    @test typeof(BipartiteNetwork(rand(3, 3))) <: Bipartite
    @test typeof(BipartiteNetwork(rand(3, 3))) <: DeterministicNetwork

    @test typeof(UnipartiteNetwork(rand(3, 3))) == UnipartiteNetwork
    @test typeof(UnipartiteNetwork(rand(3, 3))) <: Unipartite
    @test typeof(UnipartiteNetwork(rand(3, 3))) <: DeterministicNetwork
